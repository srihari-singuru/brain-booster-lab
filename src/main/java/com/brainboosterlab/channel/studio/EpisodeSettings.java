...
public record EpisodeSettings(String channelName, int puzzleCount, String textModel, String imageModel,
    ...
    public static final int MAX_PUZZLE_COUNT = 20;

    public void validate() {
        text(channelName, 48, "Channel name");
        EpisodeSpec.require(puzzleCount >= 1 && puzzleCount <= MAX_PUZZLE_COUNT,
            "Choose between 1 and " + MAX_PUZZLE_COUNT + " puzzles");
